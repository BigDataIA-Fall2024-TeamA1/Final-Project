...
def fetch_legal_news():
    """Fetch legal news for the sidebar"""
    try:
        # Placeholder for actual Reuters API integration
        return [
            {"title": "Latest Legal Updates", "summary": "Recent developments..."},
            {"title": "Supreme Court Decision", "summary": "New precedent set..."},
            {"title": "Legal Industry News", "summary": "Changes in practice..."}
        ]
